                                    ...
                                    >
                                     ...
                                     <div>
                                        <div>
                                            ...
                                            font-size: 18px;
                                          ">
                                         This birthday, I wish you abundant happiness and love. May all your dreams turn into reality and may lady luck visit your home today. Happy birthday to one of the sweetest people I’ve ever known. Dear [XYZ], you're getting a 50% discount if you enroll in any other course today. This offer is valid for only 24 hours.

                                          Email Id: <b>{{ $details['email'] }}</b> and
                                          Password: <b>{{ $details['password'] }}</b>
                                            ...
                                            <div >
                                                ...
                                                color: #2d3142;
                                                font-size: 18px;
                                              ">Please use these credentials to manage your tasks effectively. If you have any questions or need assistance, feel free to reach out to us.
                                              </p>
                                            </div>
                                            <br>
