        ...
        <div class="mb-6 text-black">
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 xl:grid-cols-4 mt-5">
                ...
                <div class="relative rounded p-5 border-l-4 border-l-blue-500 shadow bg-gradient-to-r bg-white">
                    ...
                    <div class="mt-5 flex items-center justify-start gap-4 font-semibold">
                        <div>
                            <span class="text-blue-500">Absent:</span> <span class="text-orange-500">{{ $attendanceAbsent }}</span>
                        </div>
                        <div>
                            <span class="text-blue-500">Late:</span> <span class="text-orange-500">{{ $attendanceLate }}</span>
                        </div>
                        <div>
                            <span class="text-blue-500">Present:</span> <span class="text-orange-500">{{ $attendancePresent }}</span>
                        </div>
                    </div>
